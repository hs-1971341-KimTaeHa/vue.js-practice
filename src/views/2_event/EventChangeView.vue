<template>
    <div>
        <div>
            ...
            <select name="" id="">
                <option :value="dong.dongCode" v-for="dong in selectedDongList" :key="dong.dongCode">
                    {{dong.dongTitle}}
                </option>
            </select>
            <!-- <select name="" id="">
                <option :value="dong.dongCode" v-for="dong in dongList.filter(dong => dong.cityCode === this.selectedCity)" :key="dong.dongCode">
                    {{dong.dongTitle}}
                </option>
            </select> -->
        </div>
